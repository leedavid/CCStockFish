...
int pieceSquareIndex[2][16];
int kingSquareIndex[90];
...
void Bitboards::init() {
    ...
    kingSquareIndex[3] = 0;
    kingSquareIndex[4] = 1170;
    kingSquareIndex[5] = 2340;
    kingSquareIndex[12] = 3510;
    kingSquareIndex[13] = 4680;
    kingSquareIndex[14] = 5850;
    kingSquareIndex[21] = 7020;
    kingSquareIndex[22] = 8190;
    kingSquareIndex[23] = 9360;

    kingSquareIndex[0x54] = 0;
    kingSquareIndex[0x55] = 1170;
    kingSquareIndex[0x56] = 2340;
    kingSquareIndex[0x4B] = 3510;
    kingSquareIndex[0x4C] = 4680;
    kingSquareIndex[0x4D] = 5850;
    kingSquareIndex[0x42] = 7020;
    kingSquareIndex[0x43] = 8190;
    kingSquareIndex[0x44] = 9360;
    ...
    for (PieceType pt = ROOK; pt <= KING; ++pt)
    {
        ...
        {
            auto cpt = make_piece(c, pt);
            auto ncpt = make_piece(~c, pt);
            pieceSquareIndex[c][make_piece(c, pt)] = 2 * i * 90;
            pieceSquareIndex[c][make_piece(~c, pt)] = (2 * i + (pt != KING)) * 90;
        }
        i++;
    }
